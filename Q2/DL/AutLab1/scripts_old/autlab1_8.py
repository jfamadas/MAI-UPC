...
np.save(dir + 'J_train_basic8.npy', J_train)
np.save(dir + 'acc_train_basic8.npy', acc_train)
np.save(dir + 'J_validation_basic8.npy', J_validation)
np.save(dir + 'acc_validation_basic8.npy', acc_validation)

# Save the model
export_dir = os.getcwd() + '\\model_basic8\\'
