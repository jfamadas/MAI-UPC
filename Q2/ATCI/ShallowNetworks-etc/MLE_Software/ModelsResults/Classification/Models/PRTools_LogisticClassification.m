...
function Output = PRTools_LogisticClassification (traintest,DataSet,Model,Param);
...
if ~strcmp(traintest,'train') && ~strcmp(traintest,'test')
  error('PRTools_LogisticClassification: String "traintest" invalid');
end;
