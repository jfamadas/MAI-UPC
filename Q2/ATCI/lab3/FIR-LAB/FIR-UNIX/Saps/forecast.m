function [F2,M2,S2,conf] = forecast(F1,M1,S1,B,MB,SB,mask,LM,NVeins)
%
%    PURPOSE:
%
%       Fuzzy Forecasting.
...
%      For DEF=1, CONFI=0
%
%          [f2,m2,s2] = forecast(f1,m1,s1,B,MB,SB,mask,CLASS);
%
%      For DEF=1, CONFI=1 or CONFI=2
%
%          [f2,m2,s2,conf] = forecast(f1,m1,s1,B,MB,SB,mask,CLASS);
%
%      For DEF=2 or DEF=3
%
%          [f2,m2,s2] = forecast(f1,m1,s1,B,MB,SB,mask,LM);
%
return
